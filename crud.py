...
# # Agregar destinos al inventario
...
# # Consultar algún destino del inventario
...
# # Listar los destinos del inventario
...
# # Quitar 1 unidad del destino con código 1 al carrito y 1 unidad del destino con código 2 al carrito
